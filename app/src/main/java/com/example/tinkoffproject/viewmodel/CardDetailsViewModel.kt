        ...
        State.DataState(
            listOf(
                Transaction(
                    ...
                    112213214,
                    false,
                    Category("Имя", R.drawable.ic_shop, Color.parseColor(DEFAULT_COLOR), false),
                    123,
                    "235 P"
                ),
                Transaction(
                    ...
                    112213214,
                    false,
                    Category("Имя", R.drawable.ic_sport, Color.parseColor(DEFAULT_COLOR), false),
                    123,
                    "235 P"
                ),
                Transaction(
                ...
                Transaction(
                    ...
                    112213214,
                    true,
                    Category("Имя", R.drawable.ic_income, Color.parseColor(DEFAULT_COLOR), true),
                    123,
                    "235 P"
                ),
            )
